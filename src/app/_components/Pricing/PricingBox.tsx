...
const PricingBox = (props: {
  ...
  return (
    <div className="w-full">
      <div
        className={clsx(
          "relative z-10 rounded-sm bg-white px-8 py-10 shadow-three hover:shadow-one dark:bg-gray-dark dark:shadow-two dark:hover:shadow-gray-dark",
          { "ring-4 ring-primary mt-[-22]": recommended }
        )}
      >
        ...
        <div className="mb-8 border-b border-body-color border-opacity-10 pb-8 dark:border-white dark:border-opacity-10">
          <Link href={"/subscription/buy/" + slug}>
